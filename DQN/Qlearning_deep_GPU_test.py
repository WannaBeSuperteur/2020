...
if __name__ == '__main__':
    ...
    for i in range(6):
        ...
        Qlearning_deep_GPU.deepQlearning(i, NN, op, 'mean_squared_error', states, outputs, Qdiff, 25, 'test' + str(i), [20, 25], [8, 'sigmoid', 'sigmoid'], [6, 'sigmoid', 'sigmoid'], True, True, False, deviceName)
        ...
        if i % 3 == 0 or i % 3 == 1:
            ...
            newModel = Qlearning_deep_GPU.deepLearningModel('test' + str(i) + '_0', False)
            testOutput = Qlearning_deep_GPU.modelOutput(newModel, [[4, 2.5], [6, 3.5], [7, 4.5]])
        ...
        if i % 3 == 1 or i % 3 == 2:
            ...
            newModel = Qlearning_deep_GPU.deepLearningModel('test' + str(i) + '_1', False)
            testOutput = Qlearning_deep_GPU.modelOutput(newModel, [[4, 2.5], [6, 3.5], [7, 4.5]])
            print('\n[[4, 2.5], [6, 3.5], [7, 4.5]]에 대한 학습 결과:\n')
