...
classes = ('class00', 'class01', 'class02', 'class03', 'class04', 'class05', 'class06')
...
with tf.device('/gpu:0'):
    ...
    # model
    net = tf.keras.models.load_model('signFewClassesTest_model')
    ...
    labels = np.array(pd.read_csv('signFewClassesTest_groundTruth.csv', index_col=0)).astype(float)
    predictions = np.array(pd.read_csv('signFewClassesTest_prediction.csv', index_col=0)).astype(float)
