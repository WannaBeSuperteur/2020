...
def cifar():
    path = '../TestImages/cifar/' # modified
    model_name = '../Models/Model_Cifar_128.net' # modified
...
def tinyimagenet():
    path = '../TestImages/tinyimagenet/' # modified
    model_name = '../Models/Model_TinyImageNet_128.net' # modified
    net = torch.load(model_name).to(device)
...
def mnist():
    path = '../TestImages/mnist/samples.pk' # modified
    model_name = '../Models/Model_MNIST_32.net' # modified
    f = open(path,'rb')

    # modified ref=https://stackoverflow.com/questions/56369030/runtimeerror-attempting-to-deserialize-object-on-a-cuda-device
