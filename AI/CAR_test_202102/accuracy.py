...
if __name__ == '__main__':
    ...
    test_output_to_compare = np.array(pd.read_csv('carTest_groundTruth.csv', index_col=0))
    prediction_to_compare = np.array(pd.read_csv('carTest_prediction.csv', index_col=0))
