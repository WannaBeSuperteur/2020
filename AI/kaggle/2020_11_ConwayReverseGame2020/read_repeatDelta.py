...
if __name__ == '__main__':
    ...
    # for n-sub mode (for repeatDelta, all of the n's are 5)
    makeData(1, 5, outputSize, size, 1000, False)
    makeData(2, 5, outputSize, size, 1000, False)
    makeData(3, 5, outputSize, size, 1000, False)
    makeData(4, 5, outputSize, size, 1000, False)
    makeData(5, 5, outputSize, size, 1000, False)
