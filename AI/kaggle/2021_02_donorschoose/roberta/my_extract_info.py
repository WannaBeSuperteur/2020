...
def extract(fn, option, title, onehot, years):
...
if __name__ == '__main__':
    ...
    train_option = [-1, -1, 2, -1, -1, 2, 3, 3, 5, 5, 5, 5, 5, 5, 1, 0]
    test_option = [-1, -1, 2, -1, -1, 2, 3, 3, 5, 5, 5, 5, 5, 5, 1]
    ...
    (train_extracted, train_newTitle, onehot) = extract('train.csv', train_option, train_title, None, [2016, 2017])
    ...
    (test_extracted, test_newTitle, _) = extract('test.csv', test_option, test_title, onehot, [2016, 2017])
    ...
    test_toWrite.to_csv('test_input_info.csv')
