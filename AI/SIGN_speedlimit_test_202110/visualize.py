...
def visualizeFromImgArray(imgArray, imgLabels, imgIndex, show, optionalSaveName):
    ...
    if optionalSaveName == None:
        saveName = 'signSpeedLimitTest_' + str(imgIndex) + '_' + str(imgLabels[imgIndex][0]) + '.png'
    else:
...
if __name__ == '__main__':
    ...
    # save grayscaled every 20th test images
    ...
    for i in range(imgs // 20):
        visualizeFromImgArray(imgArray, imgLabels, i*20, False, None)
