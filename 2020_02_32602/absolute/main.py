...
if __name__ == '__main__':
    ...
    SF.saveAsFile(normalize(trainOutputs_0, 50000, 50000, 6), 1, trainNormalizedOutputFileName_0) # normalized train output (comparison)
    SF.saveAsFile(normalize(trainOutputs_1, 50000, 50000, 6), 1, trainNormalizedOutputFileName_1) # normalized train output (move)
    SF.saveAsFile(normalize(trainOutputs_2, 50000, 50000, 6), 1, trainNormalizedOutputFileName_2) # normalized train output (total cost)
    ...
    SF.saveAsFile(normalize(testOutputs_0, 50000, 50000, 6), 1, testNormalizedOutputFileName_0) # normalized test output (comparison)
    SF.saveAsFile(normalize(testOutputs_1, 50000, 50000, 6), 1, testNormalizedOutputFileName_1) # normalized test output (move)
    SF.saveAsFile(normalize(testOutputs_2, 50000, 50000, 6), 1, testNormalizedOutputFileName_2) # normalized test output (total cost)
