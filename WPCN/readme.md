...
* <strong>result of experiment</strong> (```deepLearning_WPCN_forPaper.py```)
  * Common throughput maximization
    ...
    * correlation info: ```2020_11_additional_test/corrs.txt``` and ```2020_11_additional_test/corrs_201122.txt``` (can be changed)
    * correlation report: ```2020_11_additional_test/corr_report.xlsx``` and ```2020_11_additional_test/corr_report_201122.xlsx```
  * size: ```8```, ```12``` or ```16```
  * WDs: ```6``` or ```10```
