...
if __name__ == '__main__':
    ...
    for i in range(numTrain):
        ...
        optiHT.append(Qlearning_deep_GPU_helper.sigmoid(optiHT_))
    ...
    for i in range(numTrain):
        ...
        optiHT_IS = round(Qlearning_deep_GPU_helper.invSigmoid(optiHT[i], 1.0), 3)
                ...
                while True:
                    try:                  
                        ...
                        for i in range(numTest):
                            ...
                            optiHT_test = Qlearning_deep_GPU_helper.invSigmoid(testOutputLayer[0][2], 1.0) # 테스트 결과로 나온 throughput 최대화 충전시간
